...
class ThreadViewBuilder extends EntityViewBuilder {
  ...
  public function buildComponents(array &$build, array $entities, array $displays, $view_mode) {
    ...
    foreach ($entities as $id => $entity) {
      ...
      $participants = array_slice(explode(',', $entity->participants->value), 0, 2);
      $participants = implode(',', $participants);
      $participants = ptalk_generate_user_array($participants);
      $participants = ptalk_format_participants($participants);
